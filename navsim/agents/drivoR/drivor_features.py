...
class DrivoRFeatureBuilder(AbstractFeatureBuilder):
    ...
    def compute_features(
        ...
        if (
            self._config.get("use_bev_feature", False)
            and scene_token is not None
            and log_name is not None
        ):
    ...
    def maybe_load_bev_into_features(
        ...
        """Load or zero-fill BEV tensor for cached features (old caches have no BEV)."""
